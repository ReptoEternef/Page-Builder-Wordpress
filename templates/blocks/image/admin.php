...
<div class="flex-column wrap">
    ...
    <div class="flex-row">
        ...
        <input type="text" name="custom_css" value="<?= $data['custom_css'] ?? '' ?>" placeholder="css">
        
    </div>
    
    <div class="block-field" data-name="image_link">
    ...
    <input type="text" name="image_desc" value="<?= $data['image_desc'] ?? '' ?>" placeholder="description">
</div>
