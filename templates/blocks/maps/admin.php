...
<div class="flex-row wrap">
    <div class="flex-column">
        ...
        <input type="text" name="address" placeholder="Adresse" data-field-trad="notrad">
        <input type="text" name="width" placeholder="Largeur" data-field-trad="notrad">
        <input type="text" name="height" placeholder="Hauteur" data-field-trad="notrad">
    </div>
