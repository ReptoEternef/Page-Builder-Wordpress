...
class VideoPresentation extends Block {
    public $html;
    public $block_type = 'videoPresentation';
    public $display_name = 'Présentation vidéo';
    public $layouts = ['default'];

    public function __construct()
    {
        parent::__construct('videoPresentation', ['custom_css', 'layout', 'video_link_1', 'video_link_2', 'video_link_3', 'video_link_4', 'video_link_5']);
    }
