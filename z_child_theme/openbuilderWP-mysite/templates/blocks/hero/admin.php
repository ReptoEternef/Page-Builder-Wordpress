<div class="flex-column wrap inner-<?= $this->type ?>">
    ...
    <div class="flex-row">
        ...
        <div class="obwp-input-ctn">
            <input type="text" name="btn1" value="<?= $data['btn1'] ?? '' ?>" placeholder="Bouton 1">
            <input type="text" name="btn1-link" value="<?= $data['btn1-link'] ?? '' ?>" placeholder="Lien - Bouton 1">
            <input type="text" name="btn2" value="<?= $data['btn2'] ?? '' ?>" placeholder="Bouton 2">
            <input type="text" name="btn2-link" value="<?= $data['btn2-link'] ?? '' ?>" placeholder="Lien - Bouton 2">
        </div>
    </div>
